...
<div class="col-sm-7 col-md-8">
    <div class="embed-responsive embed-responsive-16by9 wowload fadeInLeft"><iframe  class="embed-responsive-item" src="https://www.youtube.com/watch?v=pgkSjFzW9k8" width="100%" height="400" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe></div>
</div>
...
<h3>Reservation</h3>
    <form role="form" class="wowload fadeInRight" method="POST" action="">
        ...
        <input class="btn btn-default" type="submit" value="Submit" name="s">
    </form>    
</div>
</div>  
</div>
